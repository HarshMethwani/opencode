...
beforeAll(async () => {
  ...
  mock.module("@quillshield/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@quillshield/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@quillshield/ui/icon", () => ({ Icon: () => null }))
  mock.module("@quillshield/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
