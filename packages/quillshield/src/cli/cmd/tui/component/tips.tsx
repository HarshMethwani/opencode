...
const TIPS = [
  ...
  "Create {highlight}quillshield.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.quillshield/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.quillshield/agent/{/highlight} for specialized AI personas",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}.quillshield/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.quillshield/plugin/{/highlight} for event hooks",
  ...
  "Create JSON theme files in {highlight}.quillshield/themes/{/highlight} directory",
