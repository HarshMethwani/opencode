...
export namespace Installation {
  ...
  export async function method() {
    if (process.execPath.includes(path.join(".quillshield", "bin"))) return "curl"
  ...
  export const USER_AGENT = `quillshield/${CHANNEL}/${VERSION}/${Flag.OPENCODE_CLIENT}`
  ...
  export async function latest(installMethod?: Method) {
    ...
    if (detectedMethod === "brew") {
      ...
      return fetch("https://formulae.brew.sh/api/formula/quillshield.json")
        .then((res) => {
    ...
    if (detectedMethod === "scoop") {
      return fetch("https://raw.githubusercontent.com/ScoopInstaller/Main/master/bucket/quillshield.json", {
